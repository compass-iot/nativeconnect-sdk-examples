...
from nativeconnect.api.v1.nativeconnect_pb2 import AuthenticateRequest
from nativeconnect.api.v1.nativeconnect_pb2_grpc import ServiceStub


HOST = "nativeconnect.cloud"
SECRET = "<<<INSERT YOUR API KEY HERE>>>"
TIMEOUT_SEC = 60 * 25  # used by retryStream


def create_native_client() -> ServiceStub:
